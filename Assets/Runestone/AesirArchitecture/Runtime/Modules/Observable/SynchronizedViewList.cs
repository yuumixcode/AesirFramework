...
{
    internal sealed class FiltableSynchronizedViewList<T, TView> : AbstractNotifyCollectionChangedSynchronizedViewList<TView>
    {
    ...
    internal sealed class NonFilteredSynchronizedViewList<T, TView> : AbstractNotifyCollectionChangedSynchronizedViewList<TView>
    {
        static readonly PropertyChangedEventArgs CountPropertyChangedEventArgs = new("Count");
        static readonly Action<NotifyCollectionChangedEventArgs> raiseChangedEventInvoke = RaiseChangedEvent;
    ...
    #if NET6_0_OR_GREATER
        // 仅服务于上方 NET6_0_OR_GREATER 的排序快路径（需要 Unsafe 重解释，Unity 无该依赖）
