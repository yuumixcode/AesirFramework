...
namespace Runestone.AesirArchitecture
{
    ...
    public static class MonoLifecycleProxyExtensions
    {
        ...
        public static AutoRemoveListenerHandle RegisterCustomLifecycle(
            this MonoBehaviour mono,
            MonoLifecycleEvent evt,
            Action callback,
            int order = 0)
        {
            return MonoLifecycleProxy.Instance.AddListener(evt, callback, order);
        }
        ...
        public static void UnregisterCustomLifecycle(
            this MonoBehaviour mono,
            MonoLifecycleEvent evt,
            Action callback)
        {
        ...
        {
            return MonoLifecycleProxy.Register(obj);
        }
    }
}
