...
- **Native PlayerLoop lifecycle** — Inject custom subsystems into Unity's PlayerLoop via `AesirArchitectureLifeCycle`, providing `BeforeUpdate` / `AfterUpdate` frame callbacks without MonoBehaviour
...
| Logging | `Debug.Log` | `AesirArchitectureLog` (conditional compilation, unified) |
...
│   │   ├── Common/
│   │   │   ├── AesirArchitectureLog.cs         # Unified logging
...
│   │   │   └── AesirViewController.cs    # View + Controller dual-role base
│   │   ├── Event/
