...
> 📦 **This package is part of the [Unity-Aesir-Packages](https://github.com/yuumixcode/Unity-Aesir-Packages) monorepo.** This package **depends on**:
...
- **Aesir Architecture (RAA)** `cn.runestone.aesir.architecture` >= 0.13.0 (required)
