namespace Runestone.AesirArchitecture.Samples
{
    ...
    /// <para>
    /// 对照：严格档（Counter-Mvc-Strict）Controller 经 Context 发布 Command，
    /// 不持有 Model、不依赖 View 注入。
    /// </para>
    ...
    public sealed class SampleMvcStandardCounterController
    {
        ...
        public SampleMvcStandardCounterController(SampleMvcStandardCounterModel model) => _model = model;
