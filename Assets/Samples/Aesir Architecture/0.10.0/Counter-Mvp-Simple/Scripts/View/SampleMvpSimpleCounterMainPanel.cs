...
{
    /// <summary>
    /// MVP-1 简单档示例 —— 计数器主面板视图。
    /// </summary>
    /// <seealso cref="SampleMvpSimpleCounterPresenter"/>
    public sealed class SampleMvpSimpleCounterMainPanel : MonoView<SampleMvpSimpleCounterContext>,
        ISampleMvpSimpleCounterView
    {
        /// <summary>
        /// 显示当前计数值的 UI 文本组件。
        /// </summary>
        ...
        SampleMvpSimpleCounterPresenter _presenter;

        void Awake()
        {
            _presenter = new SampleMvpSimpleCounterPresenter(this);
        }
