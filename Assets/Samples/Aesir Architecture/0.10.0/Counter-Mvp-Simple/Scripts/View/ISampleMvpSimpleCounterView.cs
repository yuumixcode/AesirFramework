...
{
    /// <summary>
    /// MVP-1 简单档示例 —— 计数器被动视图接口。
    /// </summary>
    /// <remarks>
    /// <para><b>不继承 IView</b>：被动视图契约不携带任何 Context 能力——
    /// 从接口层面保证"View 不访问 Model"的 MVP 边界。</para>
    /// </remarks>
    /// <seealso cref="SampleMvpSimpleCounterMainPanel"/>
    public interface ISampleMvpSimpleCounterView
    {
        /// <summary>
