# `<PrivateImplementationDetails>.__StaticArrayInitTypeSize=2671`
...
``` csharp
private struct <PrivateImplementationDetails>.__StaticArrayInitTypeSize=2671 : System.ValueType
```
